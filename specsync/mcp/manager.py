...
from specsync.mcp.clients.brave_client import BraveClient
from specsync.mcp.clients.code_search_client import CodeSearchClient
from specsync.mcp.clients.filesystem_client import FilesystemClient
from specsync.mcp.clients.github_client import GitHubClient
from specsync.mcp.clients.searchx_client import SearchXClient
from specsync.mcp.clients.spec_analysis_client import SpecAnalysisClient
    ...
    async def __aenter__(self) -> MCPManager:
        ...
        if self.config.search_provider == "brave" and self.config.brave.api_key:
            ...
            sx_params = StdioServerParameters(
                ...
                args=["-m", "specsync.mcp.servers.searchx.server"],
                env=sx_env
            )
